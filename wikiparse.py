...
def fast_iter(xml_file, out_file=None, sentinel=0):
    '''
...
python wikiparse.py ../enwiki-20190201-pages-articles-multistream1.xml-p10p30302.bz2 -s 1500 -o ../test_def.txt
    ...
    parser.add_argument('-s', '--sentinel', help='file to write the logs', default=0)
    parser.add_argument('-o', '--outfile', help='file to write the definitions', default=0)
