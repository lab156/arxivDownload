...
#SBATCH --job-name=c_18-20
#SBATCH --output=class_18-20.txt
...
singularity run --nv \
    ...
    --mine /opt/data_dir/promath/math{18,19,20}/*.tar.gz
cp -r /tmp/trainer $PROJECT/$OUTDIRNAME/trainer_logs
cp ./class_18-20.txt $PROJECT/$OUTDIRNAME/trainer_logs
