...
#SBATCH --job-name=class_11_12
#SBATCH --output=class_11_12.txt
...
OUTDIRNAME=with_mp_unsafe2_more_time
singularity run --nv \
    ...
    --mine /opt/data_dir/promath/math{11,12}/*.tar.gz
cp -r /tmp/trainer $PROJECT/$OUTDIRNAME/trainer_logs
cp ./class_11_12.txt $PROJECT/$OUTDIRNAME/trainer_logs
