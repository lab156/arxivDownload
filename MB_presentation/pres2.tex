...
\begin{frame}{Some arXiV.org website stats}
    ...
    \includegraphics[width=\textwidth]{cum_submissions.png} 
		...
		\hline
		\color{blue}{math+math-ph} & 299,046 & 22.3\% & 25.6\% \\
		\hline
		\color{brown}{hep} & 212,905 & 15.9\% & 7.8\% \\
		\hline
		cond-mat & 210,802 & 15.7\% & 11.7\% \\
		\hline
		astro-ph & 205,424 & 15.3\% & 10.7\% \\
		\hline
		\color{red}{cs} & 132,409 & 9.9\% & 21.9\% \\
		\hline
